...
class LoaderColor extends StatefulWidget {

  final Color color1;
  final Color color2;
  final Color color3;

  LoaderColor({this.color1=Colors.deepOrangeAccent,this.color2=Colors.yellow,this.color3=Colors.lightGreen});

  @override
  _LoaderColorState createState() => _LoaderColorState();
}

class _LoaderColorState extends State<LoaderColor> with TickerProviderStateMixin{
